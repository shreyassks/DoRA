...
#   - Run from root of trl repo with: accelerate launch --config_file=examples/accelerate_configs/deepspeed_zero1.yaml examples/scripts/cleaned-alpaca-llama-2-lora.py
...
class ScriptArguments:
    ...
    gradient_accumulation_steps: Optional[int] = field(
        default=4, metadata={"help": "the number of gradient accumulation steps. should match with deep speed config file"}
    )
...
# Step 5: Define the LoRA Config. I'm using the below hyperparameters as specified in the research paper
